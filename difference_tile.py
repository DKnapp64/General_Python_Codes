...
baseline_files = [x for x in files if '201908' not in x and '201909' not in x]
bleaching_files = [x for x in files if '201908' in x or '201909' in x]
...
maskfile = 'CoralTiles/' + tileid + '_coral.tif'
