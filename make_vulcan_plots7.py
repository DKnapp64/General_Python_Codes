...
data = np.genfromtxt("/scratch/dknapp4/Western_Hawaii/Moorea/moorea_sample_coral_output_rb_20190812.csv", 
...
with PdfPages('coral_change_moorea_rb_short_rev20190812.pdf') as pdf:
  ## Page 1, Red
