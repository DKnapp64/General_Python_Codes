...
data = np.genfromtxt("/scratch/dknapp4/Western_Hawaii/Moorea/moorea_sample_coral_output_sr_20190715.csv", 
...
with PdfPages('coral_brightening_rev20190715.pdf') as pdf:
  ## Page 1, Red
