...
def main(infile, outfile, chla_global):
  ...
  depthfile = '/data/gdcsdata/Research/Researcher/Knapp/Moorea_Weekly/depth/'+ os.path.splitext(os.path.basename(infile))[0] + '_depth.tif'
...
if __name__ == "__main__":
  ...
  if len( sys.argv ) != 4:
    print("[ USAGE ] you must supply two arguments: depth_rb_noauto_moorea.py infile chla")
