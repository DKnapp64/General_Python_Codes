...
root_folder_id = '0ByYTB5k_a6rsU18zLTE4a3ZOLW8'

cloud_out_dir = 'cloud_output_backup/'
root_cloud_dir = '/home/dknapp/cloud_map_backup/' + cloud_out_dir
...
while True:
  ...
  print('UTC is: %02d %02d %02d' % (nowtime.hour, minuteround, nowtime.second))
  print('Sabah time is: %02d %02d %02d' % (nowtime_sabah.hour, minuteround, nowtime_sabah.second))
  ...
  while (True):
    ...
    if ((nowtime_sabah.hour > 4) and (nowtime_sabah.hour < 17)):
      ...
      try:
        ...
        print 'ERROR: problem reaching http://www.data.jma.go.jp/mscweb/data/himawari/img/se3/se3_b13_*.jpg'
