...
def main(infile, inlutfile, outfile):
  ...
  outds.SetMetadataItem('wavelength', "{ 475.0, 540.0, 625.0, 800.0 }", 'ENVI')
...
if __name__ == "__main__":
  ...
  if len( sys.argv ) != 4:
    print("[ ERROR ] you must supply 3 arguments: apply_refl_lut.py inradfile inlutfile outreflfile")
    print("where:")
