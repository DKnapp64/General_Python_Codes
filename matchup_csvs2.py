...
asdcsvfile = "/scratch/dknapp4/ASD/Moorea_Dove_BGR_from_ASD.csv"
dovecsvfile = "/scratch/dknapp4/ASD/Spectroscopy/20190604_moorea_tile_sr_rb.csv"
outfile = "Moorea_Dove_ASD_matched_20190712.csv"
