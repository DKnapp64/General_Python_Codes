...
def main(inimg):
  ...
  clavgimg = '/data/gdcsdata/Research/Researcher/Knapp/Yaping_stuff/Xu/GBR_Weekly/Cloud_Baseline/mean/gbr_mean.vrt'
  ...
  clstdimg = '/data/gdcsdata/Research/Researcher/Knapp/Yaping_stuff/Xu/GBR_Weekly/Cloud_Baseline/stdev/gbr_stdev.vrt'
  ...
  for j in [0,1]:
    ...
    commdove2 = '%12.2f %12.2f %12.2f %12.2f -tr %6.2f %6.2f %s %s' % (ulx, lry, lrx, uly, clagt[1], clagt[1], mylist1[j], mylist2[j]) 
...
if __name__ == "__main__":                                                      
  ...
  if len( sys.argv ) != 2:
    print("[ ERROR ] you must supply 1 argument: mask_clouds_gbr.py in_surface_refl_file")
    print("where:")
