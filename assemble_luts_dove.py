...
def main(inroot, outputdir):
  ...
  np.savez(outputdir+os.sep+inroot+"_luts.npz", rangeblue=rangeblue, rangegreen=rangegreen, \
    rangered=rangered, rangenir=rangenir)
...
if __name__ == "__main__":
  ...
  if len( sys.argv ) != 3:
    print("[ ERROR ] you must supply 2 arguments: assemble_luts_dove.py inroot outputdir")
