...
for thedir in thedirs:
  tilepath = thedir + os.path.sep + 'descending/' + tileid + '_br_comp.tif'
...
temp_bleaching_files = [x for x in files if '201909' not in x[12:20] and '201910' not in x[12:20] and '201911' not in x[12:20] and '201912' not in x[12:20]]
bleaching_files = []
...
baselinefile = '/scratch/dknapp4/GBR/AscendingDescending/BaseFiles/'+tileid+'_base.tif'
...
outdir = '/scratch/dknapp4/GBR/AscendingDescending/Persistent_Deviation/'+stopdate.strftime('%Y%m%d')+'/'
