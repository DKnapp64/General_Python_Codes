...
## baseline_files = [x for x in files if '201812' in x or '201901' in x or '201902' in x or '201903' in x]
temp_bleaching_files = [x for x in files if '201812' not in x and '201901' not in x and '201902' not in x and '201903' not in x]
bleaching_files = []
