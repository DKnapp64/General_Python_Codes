...
pdevfiles = ['persdev_mosaic_20190813.tif', 
'persdev_mosaic_20190820.tif', 
'persdev_mosaic_20190827.tif', 
'persdev_mosaic_20190903.tif', 
'persdev_mosaic_20190910.tif', 
'persdev_mosaic_20190917.tif', 
'persdev_mosaic_20190924.tif', 
'persdev_mosaic_20191001.tif', 
'persdev_mosaic_20191008.tif', 
'persdev_mosaic_20191015.tif', 
'persdev_mosaic_20191022.tif', 
'persdev_mosaic_20191029.tif', 
'persdev_mosaic_20191105.tif', 
'persdev_mosaic_20191112.tif', 
...
for k,uval in enumerate(vals):
  pDS = gdal.Open(pdevfiles[k], gdal.GA_ReadOnly)
  ...
  if (numpix >= 2000):
    ...
    rows = index[0]
    cols = index[1]
  np.save('randomsample_row_num%02d_20191201.npy' % (uval), rows)
  np.save('randomsample_col_num%02d_20191201.npy' % (uval), cols)
  basesamp = basedata[rows, cols]
  np.save('basesamp_num%02d_20191201.npy' % (uval), basesamp)
  ...
  for j,rbname in enumerate(rbmosfiles):
    ...
    np.save('rbsamp_%s_num%02d_20191201.npy' % (thedate,uval), rbsamp)
    del rbdata
    rbDS = None
